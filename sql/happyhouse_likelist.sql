...
CREATE TABLE `likelist` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `likelist_ibfk_1` FOREIGN KEY (`id`) REFERENCES `user` (`id`) ON DELETE CASCADE
...
INSERT INTO `likelist` VALUES ('ssafy','56331'),('ssafy','56331'),('ssafy','57920');
...
-- Dump completed on 2021-05-27 20:11:19
